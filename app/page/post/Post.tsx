  ...
  return (
    <div className="post-page-content">
        <div className="card-body">
            <input type="text" className="input-date" value='January 20, 2024' hidden />
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 05, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 19, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 10, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 21, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body ">
            <input type="text" className="input-date" value='January 02, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 24, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
        ...
        <div className="card-body">
            <input type="text" className="input-date" value='January 14, 2024' hidden />
            <div className="postheader">
            <div className='postheadername'>
                <div className="post-user image"><Image src={profileuser} className='img' alt="Profile User"/></div>
                <div className="">
